...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-ZPDAOUHY.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-CFRVNBKX.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-6PV64BEM.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-YUJE24VB.js")).default(client, argv, telemetry);
    default:
