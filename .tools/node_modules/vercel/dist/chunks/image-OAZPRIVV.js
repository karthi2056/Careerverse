...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-PCEHXUR6.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-IY7LHGUX.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-RMSGUZSC.js")).default(client, args, telemetry);
    default:
