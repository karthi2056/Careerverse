...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-GIWVQKCG.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-GIWVQKCG.js")).default(client, args);
    case "schema":
      return (await import("./schema-45SJNY5L.js")).default(client, args);
    case "add":
      return (await import("./add-E45DFT3J.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-BKT5BO6Y.js")).default(client, args);
    case "rm":
      return (await import("./rm-VAGUMQMB.js")).default(client, args);
    case "update":
      return (await import("./update-AMHBMC5O.js")).default(client, args);
    default:
